					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Multi Value UI Elements",
									"targetURL": "#multivalue-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"multivalue-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=multivalue",
									"url": sap.ui.require.toUrl("multivalue")
								}
							}
						}
					}
